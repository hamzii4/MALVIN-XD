...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "MALVIN-XD~p4w2HJqD#HyQc0CXDHuKyW5r3VXbAJhK1xQm0iNDYN2wfQpNJuqo",
// add your Session Id ,session id starts with MALVIN-XD~

PREFIX: process.env.PREFIX || ".",
// add your prifix for bot

BOT_NAME: process.env.BOT_NAME || "𓆩๛⃝𓆩𝐇ɑɱ͜͡ʒɑ̽𓆪‣᭄𓆪⸙𝐗̴͜͡𝐃‣᭄𓆪",
...
OWNER_NUMBER: process.env.OWNER_NUMBER || "923146056950",
// add your bot owner number

OWNER_NAME: process.env.OWNER_NAME || "✦ᴍᴀʟᴠɪɴ ᴛᴇᴄʜ🪀✦",
// add bot owner name

DESCRIPTION: process.env.DESCRIPTION || "> *© ᴘᴏᴡᴇʀᴇᴅ ʙʏ 𓆩๛⃝𓆩𝐇ɑɱ͜͡ʒɑ̽𓆪‣᭄𓆪⸙𝐗̴͜͡𝐃‣᭄𓆪*",
// add bot owner name    

ALIVE_IMG: process.env.ALIVE_IMG || "https://i.ibb.co/dsgpL8mF/temp-image.jpg",
// add img for alive msg

MENU_IMG: process.env.MENU_IMG || "https://i.ibb.co/dsgpL8mF/temp-image.jpg",
